...
def main():
    ...
    try:
        ...
        explorer = DataExplorer(processed_dir="data/processed")
        report = explorer.generate_report()
        explorer.save_report(report, output_path="data/processed/eda_report.json")
        logger.info(f"✅ Data Exploration Complete")
        logger.info(f"   Report saved to: data/processed/eda_report.json")
    except Exception as e:
    ...
    try:
        ...
        # Test single image
        example_img = Path("data/processed/train/normal")
        ...
        # Test batch loading
        loader = DataLoader(processed_dir="data/processed")
    ...
    logger.info("="*70)
    logger.info("\n📊 Next Steps:")
    logger.info("   1. Review EDA report: data/processed/eda_report.json")
