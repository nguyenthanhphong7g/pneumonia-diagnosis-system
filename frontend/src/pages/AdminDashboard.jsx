        ...
        <Fade in={true}>
            <Box sx={{ p: { xs: 2, md: 4 }, backgroundColor: '#f8fafc', minHeight: '100vh' }}>
                ...
                <Grid container spacing={0} sx={{ mb: 4, gap: 2 }}>
                    {[
                        { label: 'Tổng số mẫu', value: stats?.totalReviews, color: '#2563eb', bg: '#eff6ff' },
                        ...
                        { label: 'Viêm phổi | Bình thường', value: `${stats?.pneumoniaCount || 0} / ${stats?.normalCount || 0}`, color: '#ef4444', bg: '#fef2f2' }
                    ].map((item, index) => (
                        ...
                        <Card sx={{ borderRadius: '20px', border: '1px solid #e2e8f0' }}>
                            <CardContent sx={{ p: 3 }}>
                                <Typography variant="h6" sx={{ fontWeight: 700, mb: 2, display: 'flex', alignItems: 'center', gap: 1 }}>
                                    <RecentIcon color="action" /> Dữ liệu mới chưa huấn luyện lại
                                </Typography>
